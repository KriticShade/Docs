...
function Write-UserRow($ws, $row, $label, $couleurLigne, $couleurCroix, $groupes, $membresParGroupe, $samComplet) {
    # Toute la ligne en couleur alternee
...
# Cellule A1 - diagonale, fond sombre
...
# En-tetes groupes fonctionnels - diagonale 45, texte NOIR
$colIndex  = 2
$colorIndex = 0
foreach ($groupe in $groupes) {
...
# Couleur unique pour les croix (gris fonce)
